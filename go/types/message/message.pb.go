...
const (
	MessageType_LIST_FILES MessageType = 0
)
...
type Message struct {
	...
	Type  MessageType            `protobuf:"varint,2,opt,name=type,proto3,enum=p2p2p.MessageType" json:"type,omitempty"`
	// Types that are valid to be assigned to Payload:
	//
	//	*Message_FileDownloadRequest
	//	*Message_FileUploadRequest
	//	*Message_FileList
	//	*Message_FileContents
	//	*Message_Decline
...
func (x *Message) GetFileContents() *FileContents {
	if x != nil {
		if x, ok := x.Payload.(*Message_FileContents); ok {
...
func (x *Message) GetDecline() *Decline {
	if x != nil {
		if x, ok := x.Payload.(*Message_Decline); ok {
			return x.Decline
		}
	}
	return nil
...
func (x *Message) GetConfirmation() *Confirmation {
	if x != nil {
		if x, ok := x.Payload.(*Message_Confirmation); ok {
...
type Message_FileDownloadRequest struct {
	FileDownloadRequest *FileDownloadRequeset `protobuf:"bytes,3,opt,name=file_download_request,json=fileDownloadRequest,proto3,oneof"`
}

type Message_FileUploadRequest struct {
	FileUploadRequest *FileUploadRequest `protobuf:"bytes,4,opt,name=file_upload_request,json=fileUploadRequest,proto3,oneof"`
}

type Message_FileList struct {
	FileList *FileList `protobuf:"bytes,5,opt,name=file_list,json=fileList,proto3,oneof"`
}

type Message_FileContents struct {
	FileContents *FileContents `protobuf:"bytes,6,opt,name=file_contents,json=fileContents,proto3,oneof"`
}

type Message_Decline struct {
	Decline *Decline `protobuf:"bytes,7,opt,name=decline,proto3,oneof"`
}

type Message_Confirmation struct {
...
func (*Message_FileContents) isMessage_Payload() {}

func (*Message_Decline) isMessage_Payload() {}

func (*Message_Confirmation) isMessage_Payload() {}
...
var file_pb_message_proto_rawDesc = string([]byte{
	...
	0x28, 0x0c, 0x52, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0xbe, 0x03, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x70,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	,
	...
	0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x05, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70, 0x32, 0x70, 0x32,
	0x70, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x05,
	0x66, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x36, 0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20,
	...
	0x61, 0x2a, 0x1d, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x0e, 0x0a, 0x0a, 0x4c, 0x49, 0x53, 0x54, 0x5f, 0x46, 0x49, 0x4c, 0x45, 0x53, 0x10, 0x00,
	0x42, 0x1a, 0x5a, 0x18, 0x67, 0x6f, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x73,
...
var file_pb_message_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_pb_message_proto_goTypes = []any{
	...
	(*FileList)(nil),             // 7: p2p2p.FileList
	(*FileMetadata)(nil),         // 8: p2p2p.FileMetadata
	(*FileContents)(nil),         // 9: p2p2p.FileContents
}
var file_pb_message_proto_depIdxs = []int32{
	...
	7, // 3: p2p2p.Message.file_list:type_name -> p2p2p.FileList
	9, // 4: p2p2p.Message.file_contents:type_name -> p2p2p.FileContents
	3, // 5: p2p2p.Message.decline:type_name -> p2p2p.Decline
	4, // 6: p2p2p.Message.confirmation:type_name -> p2p2p.Confirmation
	8, // 7: p2p2p.FileList.files:type_name -> p2p2p.FileMetadata
...
func file_pb_message_proto_init() {
	...
	file_pb_message_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*Message_FileContents)(nil),
		(*Message_Decline)(nil),
		(*Message_Confirmation)(nil),
	}
	type x struct{}
